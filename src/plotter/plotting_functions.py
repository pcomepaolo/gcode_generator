...
def gen_plate_shape(
    ...
    Returns:
        tuple[list,list]: the list of x and y coordinates of the printing plate perimeter
    """
    match plate_shape:
        case 'squared':
...
def gen_serpentine_area(
    ...
    Returns:
        list[list[float]]: the coordinates of the vertices of the rectangle describing the maximum area of the serpentine
    """
